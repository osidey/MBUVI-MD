...
<p align="center">
  ...
  <a aria-label="MBUVI_MD is free to use" href="https://github.com/SuhailTechInfo/Suhail-Md/blob/main/LICENCE" target="_blank">
    <img alt="License: GPL-3" src="https://badges.frapsoft.com/os/gpl/gpl.png?v=103)](https://opensource.org/licenses/GPL-3.0/" target="_blank" />
  </a>
  <a aria-label="MBUVI_MD is free to use" href="https://youtube.com/@suhailtechinfo" target="_blank">
...
## Deployment Methods
---
1.  ***Get `SESSION ID` by  [`PARING CODE`](https://suhail-md-vtsf.onrender.com/code). And then `Go-to Whatapp>Three dots>Linked Devices`***
